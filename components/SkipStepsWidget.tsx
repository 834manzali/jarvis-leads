...
export function SkipStepsWidget({ onContinueWithManager, onContinueForm, onBack }: SkipStepsWidgetProps) {
  return (
    <div className="space-y-6 sm:space-y-8">
      ...
      <div className="grid gap-4 sm:gap-6">
        ...
        >
          <Button
            ...
            variant="outline"
            className="w-full p-5 sm:p-6 h-auto text-left border-2 border-orange-500/30 hover:border-orange-500/60 bg-gradient-to-r from-orange-500/10 to-orange-600/10 hover:from-orange-500/20 hover:to-orange-600/20 transition-all duration-300 min-h-[120px]"
          >
        ...
        >
          <Button
            ...
            variant="outline"
            className="w-full p-5 sm:p-6 h-auto text-left border-2 border-blue-500/30 hover:border-blue-500/60 bg-gradient-to-r from-blue-500/10 to-blue-600/10 hover:from-blue-500/20 hover:to-blue-600/20 transition-all duration-300 min-h-[120px]"
          >
            <div className="flex items-start space-x-3 sm:space-x-4">
      ...
      {/* Info */}
      <div className="bg-gray-700/50 border border-gray-600 rounded-xl p-4 sm:p-5 mt-8">
